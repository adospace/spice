...
{
	TResult GetNativeControl<TResult>() where TResult : class, INotifyPropertyChanging, INotifyPropertyChanged, new();

	void Attach(object nativeControl);
}
...
public abstract class VisualNode<T> : VisualNode, IVisualNodeWithNativeControl/*, IVisualNodeWithAttachedProperties*/ where T : class, INotifyPropertyChanging, INotifyPropertyChanged, new()
{
	protected object? _nativeControl;
	...
	private void NativeControl_PropertyChanging(object? sender, PropertyChangingEventArgs e)
	{
	...
	void IVisualNodeWithNativeControl.Attach(object nativeControl)
	{
		_nativeControl = nativeControl;
	}

	//	protected void SetPropertyValue(object dependencyObject, BindableProperty property, IPropertyValue? propertyValue)
	//	{
	...
	//	protected bool SetPropertyValue(object dependencyObject, BindableProperty property, object? newValue)
	//	{
	//		var oldValue = dependencyObject.GetValue(property);
